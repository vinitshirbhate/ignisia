...
// import { AlertCircle, CheckCircle2, FileUp, Loader2, ShieldAlert } from "lucide-react"
...
// const apiBaseUrl =
//   process.env.NEXT_PUBLIC_AI_VALIDATE_API_URL?.replace(/\/$/, "") ?? "http://127.0.0.1:8000"
...
// export function AIValidateDemo() {
...
//             This connects the frontend directly to the FastAPI validator so you can inspect score,
//             risk level, missing sections, and issue-by-issue feedback in one place.
//           </p>
//         </div>
...
//             <CardHeader>
//               <CardTitle className="text-2xl font-black text-black">Run validation</CardTitle>
//               <CardDescription className="text-sm font-medium text-black/70">
//                 PDF only. The backend must be running on <code>{apiBaseUrl}</code>.
//               </CardDescription>
//             </CardHeader>
...
//                 <Button onClick={handleSubmit} disabled={!file || isSubmitting} size="lg">
//                   {isSubmitting ? (
//                     <>
...
//                 </Button>
//                 {file ? (
//                   <span className="text-sm font-bold text-black/70">{(file.size / 1024 / 1024).toFixed(2)} MB</span>
//                 ) : null}
//               </div>
...
//           <Card className="border-[4px] border-black bg-white shadow-[8px_8px_0_0_#000]">
//             <CardHeader>
//               <CardTitle className="text-2xl font-black text-black">Validation output</CardTitle>
//               <CardDescription className="text-sm font-medium text-black/70">
//                 Results are rendered from the API response as soon as the review completes.
//               </CardDescription>
//             </CardHeader>
//             <CardContent className="space-y-6">
//               {!result ? (
//                 <div className="flex min-h-80 flex-col items-center justify-center border-[3px] border-black bg-[#F8FAFC] p-8 text-center">
//                   <ShieldAlert className="h-12 w-12 text-black" strokeWidth={2.5} />
//                   <p className="mt-4 text-lg font-black text-black">No report yet</p>
//                   <p className="mt-2 max-w-md text-sm font-medium text-black/70">
//                     Upload a PDF and run validation to see the proposal score, risk level, and the
//                     most important issues called out here.
//                   </p>
//                 </div>
//               ) : (
//                 <>
...
//                         Risk level
//                       </p>
//                       <Badge className={`mt-3 text-sm font-black ${riskBadgeClasses(result.risk_level)}`}>
...
//                       <p className="mb-3 text-sm font-black text-black">Strengths</p>
//                       <div className="space-y-3">
//                         {(result.strengths?.length ? result.strengths : ["No strengths were returned."]).map(
//                           (strength) => (
//                             <div key={strength} className="flex gap-3 text-sm font-medium text-black/80">
...
//                     <div className="border-[3px] border-black bg-white p-4">
//                       <p className="mb-3 text-sm font-black text-black">Missing sections</p>
//                       <div className="space-y-3">
//                         {(
...
//                         ).map((section) => (
//                           <div key={section} className="flex gap-3 text-sm font-medium text-black/80">
...
//                               Fix: <span className="font-medium">{issue.recommendation}</span>
//                             </p>
//                           ) : null}
//                           {issue.impact ? (
