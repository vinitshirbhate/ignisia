...
export function ProductPreview() {
  return (
    <section id="product" className="border-y border-border bg-secondary/30 px-6 py-16 md:py-24">
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            A clear, data-driven interface that helps you make informed bidding decisions.
          </p>
        </div>
            ...
            <Card className="shadow-none">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between border-b border-border pb-2">
                    <span className="text-muted-foreground">Profit Margin (20%)</span>
                    <span className="font-medium">$3,094</span>
                  </div>
                  <div className="flex justify-between pt-1">
                    <span className="font-semibold">Total Bid</span>
                    <span className="text-lg font-bold text-primary">$18,562</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-none">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="mb-1 flex justify-between text-sm">
                      <span className="text-muted-foreground">Acme Corp (Est.)</span>
                      <span>$19,800</span>
                    </div>
                  ...
                  <div>
                    <div className="mb-1 flex justify-between text-sm">
                      <span className="text-muted-foreground">BuildRight Inc (Est.)</span>
                      <span>$17,200</span>
                    </div>
                  ...
                  <div>
                    <div className="mb-1 flex justify-between text-sm">
                      <span className="text-muted-foreground">QuickBuild (Est.)</span>
                      <span>$20,500</span>
                    </div>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-lg border border-border bg-secondary/50 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                BuildRight Inc typically bids 7% below market average. Consider highlighting your quality guarantees to justify pricing.
              </p>
            </div>
          </div>
        </div>
